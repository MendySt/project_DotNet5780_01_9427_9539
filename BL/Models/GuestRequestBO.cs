...
namespace BO.Models
{
    public class GuestRequestBO
    {
        ...
        public override string ToString()=> $"{Status} {Area} {Type} {Pool} {Jacuzzi} {Garden} {ChildrensAttractions}" +
            $" {Key} {ClientId} {Adults} {Children }{CreateDate} {EntryDate} {LeaveDate } class GuestRequestBO";
